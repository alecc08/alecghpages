...
const ListKeeper = () => {
  ...
  return (
    <div className="project-page">
      ...
      <section className="project-legal card">
        <h2>Legal & Privacy</h2>
        <p>
          For privacy information, see the <a href="/privacy-policy-listkeeper-en.html" target="_blank" rel="noopener noreferrer">ListKeeper Privacy Policy</a>.
        </p>
      </section>
    </div>
  );
